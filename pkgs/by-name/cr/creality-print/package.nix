...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-Ri+W2OUsmduLo+w54cueHTwMthjb4gd5+fPkuOZDBiw=";
  };
  ...
  meta = {
    description = "G-code generator for 3D printers (Creality, etc.)";
    homepage = "https://github.com/CrealityOfficial/CrealityPrint";
    changelog = "https://github.com/CrealityOfficial/CrealityPrint/releases/tag/${finalAttrs.version}";
